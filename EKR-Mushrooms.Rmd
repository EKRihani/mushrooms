...
\paragraph*{}
These results underline an interesting fact : not all random forest models are created equal. In the first step of the preliminary studies of the caret package models, some random forest models proved to be extremely slow, while others were considerably faster. This study also shows the considerable difference in sensitivity and specificity between the rFerns and the Ranger or Rborist random forest models.
...
```{r out.width = "100%", echo = FALSE}
kable(rt_result, caption = "Ranger and Rborist models performance (vs. evaluation)")
```  
