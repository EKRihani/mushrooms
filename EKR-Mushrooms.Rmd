...
\paragraph*{}
Our classification strategy is based on one rule : the specificity on the edibility criterion must be equal to 1, false negative are not tolerated. In layman's terms, a good algorithm should never classify a poisonous mushroom as edible.
\paragraph*{}
Given this constraint, a "stupid" algorithm can be designed as a benchmark. This algorithm will simply classify all mushrooms as poisonous.
\paragraph*{}
