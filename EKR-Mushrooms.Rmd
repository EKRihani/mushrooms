...
plot(ggarrange(
   ...
   train_distrib_habitat + ggtitle("Habitat") + ggtitle("") + ylab("") + scale_y_log10(labels = NULL) + theme(legend.position = "none", axis.text.x = element_text(angle = 60, vjust = 1, hjust=1)),
   train_distrib_stem.color + ggtitle("Stem Color") + ggtitle("") + ylab("") + scale_y_log10(labels = NULL) + theme(legend.position = "none", axis.text.x = element_text(angle = 60, vjust = 1, hjust=1)),
   train_distrib_veil.color + ggtitle("Veil Color") + ggtitle("") + ylab("") + scale_y_log10(labels = NULL) + theme(axis.text.x = element_text(angle = 60, vjust = 1, hjust = 1))
   )
)
```  
\paragraph*{}
...
\paragraph*{}
Our classification strategy is based on one rule : the specificity on the edibility criterion must be equal to 1. In other words, non-edible mushroom should never be classified as edible.
\newpage
\section{Results}
