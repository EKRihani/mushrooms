...
```
Quite interestingly, despite have no tuning parameter, this model gave excellent and veri balanced results, with both very high sensitivity and specificity. Still, this model didn't achieve the *Spec = 1* criterion.
