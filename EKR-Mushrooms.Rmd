...
\subsubsection{Single and dual criteria analysis}  
...
\paragraph*{}
A slightly more elaborate algorithm will classify mushrooms as edible if they meet one criterion. For example, in the distributions showed above, the mushroom will be edible if *cap.diameter* > 40, if *spore.print.color* = gray or if *veil.color* = yellow.
